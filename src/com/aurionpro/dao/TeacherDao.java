...
//	}
	...
	public List<Teacher> getAllActiveTeachers() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				Teacher teacher = new Teacher(id, fname, lname, mobile, email, is_active);
	...
	public boolean deleteATeacher(int teacherId) {
		try {
			preparedStatement = connection.prepareStatement("UPDATE teachers SET is_active = ? WHERE teacher_id = ? AND is_active = true");
	...
	public boolean activateTeacher(int teacherId) {
		try {
			PreparedStatement preparedStatement = connection.prepareStatement("UPDATE teachers SET is_active = true WHERE teacher_id = ?"); 
	    	preparedStatement.setInt(1, teacherId);
	...
	public void assignSubject(String courseSubjectId, int teacherId, boolean is_active) {
